...
import static tech.liujin.network.state.manager.NetStateChangeManager.ONLY_MOBILE_CONNECT;
import static tech.liujin.network.state.manager.NetStateChangeManager.ONLY_WIFI_CONNECT;
import static tech.liujin.network.state.manager.NetStateChangeManager.WIFI_MOBILE_CONNECT;
import static tech.liujin.network.state.manager.NetStateChangeManager.WIFI_MOBILE_DISCONNECT;
